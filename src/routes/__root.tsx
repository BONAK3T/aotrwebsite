...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AOT:R Values — Attack on Titan Revolution Trading Value Centre" },
      { name: "description", content: "Live trading values, demand ratings, and weekly changes for every item in Attack on Titan Revolution." },
      { property: "og:title", content: "AOT:R Values — Trading Value Centre" },
      { property: "og:description", content: "Live trading values and weekly changes for Attack on Titan Revolution." },
